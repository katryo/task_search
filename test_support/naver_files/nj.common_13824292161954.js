...
(function($){nj.getPackage("nj.UIClassBase",new (function($NAME){var ERROR={SINGLETON_WIDGET_DUPLICATED:function($sWidgetName){return new Error("["+$NAME+"] Widget "+$sWidgetName+" must be created with only one element");
},WIDGET_UNDEFINED:function($sWidgetName){return new Error("["+$NAME+"] Widget "+$sWidgetName+" is undefined.");
}};
function UIClassBase(){}UIClassBase.NAME=$NAME;
UIClassBase.prototype={_data:function($sKey_$oReferences,$oValue){var sKey;
var fn=arguments.callee;
if(!arguments.length){return this._oDataMap;
...
if((this._oDataMap[sKey]=$oValue)===undefined){delete this._oDataMap[sKey];
...
this._oOptions={server:"http://cc.naver.jp/cc",attr:"na"};
this._oParams={v:"2.0"};
